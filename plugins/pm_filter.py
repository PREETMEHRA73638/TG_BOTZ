...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/dark_official_group_07>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/dark_official_group_07")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/dark_official_group_07")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ ⌬', url="https://t.me/dark_official_group_07")
                ],[
                    InlineKeyboardButton('꧁ Hᴇʟᴘ ꧂', callback_data='help'),
                    InlineKeyboardButton('🍂⃤ Aʙᴏᴜᴛ 🍂⃤', callback_data='about') 
                ],[
                    InlineKeyboardButton('「◥꧁ད Gᴇᴛ Aᴅᴢ Fʀᴇᴇ Fɪʟᴇ ཌ꧂◤」', callback_data='kushal') 
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
             InlineKeyboardButton('꧁𓊈ꜰɪʟᴇ ꜱᴛᴏʀᴇ𓊉꧂', callback_data='store_file'),   
             InlineKeyboardButton('꧁༒ᴛᴇʟᴇɢʀᴀᴘʜ༒꧂', callback_data='tele') 
         ], [ 
             InlineKeyboardButton('꧁•⊹٭ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ٭⊹•꧂', callback_data='coct'), 
             InlineKeyboardButton('(-_-)ᴇᴀʀɴ ᴍᴏɴᴇʏ(-_-) ', callback_data='shortlink_info') 
         ], [ 
             InlineKeyboardButton('◥꧁དFILTERSཌ꧂◤', callback_data='filters'), 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('|I{•-»Sᴏᴜʀᴄᴇ Cᴏᴅᴇ«-•}I|', callback_data='source')
        ],[
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://telegra.ph/file/b92b501a62828d1d5072b.jpg")
        ) 
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('Send ScreenShot', url="https://t.me/Anmol03y"), 
            InlineKeyboardButton('HOW ITS WORK', url="https://t.me/MOVIES_VILLA_UPDATE/29") 
        ],[
            InlineKeyboardButton('CHECK PLANS', callback_data='check')
        ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Anmol03y")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
